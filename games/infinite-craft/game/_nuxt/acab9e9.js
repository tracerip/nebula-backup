            ...
            (function(t) {
                ...
                ! function() {
                    ...
                    r.prototype = {
                        ...
                        volume: function(e) {
                            var n = this || d;
                            if (e = parseFloat(e), n.ctx || A(), void 0 !== e && e >= 0 && e <= 1) {
                        ...
                        stop: function() {
                            for (var e = this || d, i = 0; i < e._howls.length; i++) e._howls[i].stop();
                            return e
                        },
                        unload: function() {
                            for (var e = this || d, i = e._howls.length - 1; i >= 0; i--) e._howls[i].unload();
                            return e.usingWebAudio && e.ctx && void 0 !== e.ctx.close && (e.ctx.close(), e.ctx = null, A()), e
                        },
                        codecs: function(e) {
                        ...
                        _unlockAudio: function() {
                            ...
                            if (!e._audioUnlocked && e.ctx) {
                                ...
                                var n = function(t) {
                                    ...
                                    source.buffer = e._scratchBuffer, source.connect(e.ctx.destination), void 0 === source.start ? source.noteOn(0) : source.start(0), "function" == typeof e.ctx.resume && e.ctx.resume(), source.onended = function() {
                                        source.disconnect(0), e._audioUnlocked = !0, document.removeEventListener("touchstart", n, !0), document.removeEventListener("touchend", n, !0), document.removeEventListener("click", n, !0), document.removeEventListener("keydown", n, !0);
                        ...
                        _releaseHtml5Audio: function(audio) {
                            var e = this || d;
                            return audio._unlocked && e._html5AudioPool.push(audio), e
                        },
                        ...
                        _autoResume: function() {
                            var e = this;
                            if (e.ctx && void 0 !== e.ctx.resume && d.usingWebAudio) return "running" === e.state && "interrupted" !== e.ctx.state && e._suspendTimer ? (clearTimeout(e._suspendTimer), e._suspendTimer = null) : "suspended" === e.state || "running" === e.state && "interrupted" === e.ctx.state ? (e.ctx.resume().then((function() {
                                e.state = "running";
                                for (var i = 0; i < e._howls.length; i++) e._howls[i]._emit("resume")
                    ...
                    _.prototype = {
                        init: function(e) {
                            ...
                            return d.ctx || A(), n._autoplay = e.autoplay || !1, n._format = "string" != typeof e.format ? e.format : [e.format], n._html5 = e.html5 || !1, n._muted = e.mute || !1, n._loop = e.loop || !1, n._pool = e.pool || 5, n._preload = "boolean" != typeof e.preload && "metadata" !== e.preload || e.preload, n._rate = e.rate || 1, n._sprite = e.sprite || {}, n._src = "string" != typeof e.src ? e.src : [e.src], n._volume = void 0 !== e.volume ? e.volume : 1, n._xhr = {
                                ...
                                fn: e.onunlock
                            }] : [], n._onresume = [], n._webAudio = d.usingWebAudio && !n._html5, void 0 !== d.ctx && d.ctx && d.autoUnlock && d._unlockAudio(), d._howls.push(n), n._autoplay && n._queue.push({
                                event: "play",
                                action: function() {
                                    n.play()
                                }
                        ...
                        load: function() {
                            var e = this,
                                n = null;
                            if (d.noAudio) e._emit("loaderror", null, "No audio support.");
                            else {
                                "string" == typeof e._src && (e._src = [e._src]);
                                for (var i = 0; i < e._src.length; i++) {
                                    var t, o;
                                    if (e._format && e._format[i]) t = e._format[i];
                                    else {
                                        if ("string" != typeof(o = e._src[i])) {
                                            e._emit("loaderror", null, "Non-string found in selected audio sources - ignoring.");
                                            continue
                                        }(t = /^data:audio\/([^;,]+);/i.exec(o)) || (t = /\.([^.]+)$/.exec(o.split("?", 1)[0])), t && (t = t[1].toLowerCase())
                                    }
                                ...
                                if (n) return e._src = n, e._state = "loading", "https:" === window.location.protocol && "http:" === n.slice(0, 5) && (e._html5 = !0, e._webAudio = !1), new l(e), e._webAudio && f(e), e;
                        ...
                        play: function(e, n) {
                            ...
                            if (!_) return null;
                            if (o && !e && (e = _._sprite || "__default"), "loaded" !== t._state) {
                            ...
                            if (o && !_._paused) return n || t._loadQueue("play"), _._id;
                            ...
                            _._sprite = e, _._ended = !1;
                            var A = function() {
                                _._paused = !1, _._seek = c, _._start = v, _._stop = h, _._loop = !(!_._loop && !t._sprite[e][2])
                            };
                            if (!(c >= h)) {
                                var y = _._node;
                                if (t._webAudio) {
                                    var w = function() {
                                        t._playLock = !1, A(), t._refreshBuffer(_);
                                        var e = _._muted || t._muted ? 0 : _._volume;
                                        y.gain.setValueAtTime(e, d.ctx.currentTime), _._playStart = d.ctx.currentTime, void 0 === y.bufferSource.start ? _._loop ? y.bufferSource.noteGrainOn(0, c, 86400) : y.bufferSource.noteGrainOn(0, c, f) : _._loop ? y.bufferSource.start(0, c, 86400) : y.bufferSource.start(0, c, f), m !== 1 / 0 && (t._endTimers[_._id] = setTimeout(t._ended.bind(t, _), m)), n || setTimeout((function() {
                                            t._emit("play", _._id), t._loadQueue()
                                        }), 0)
                                    };
                                    "running" === d.state && "interrupted" !== d.ctx.state ? w() : (t._playLock = !0, t.once("resume", w), t._clearTimer(_._id))
                                } else {
                                    var T = function() {
                                        y.currentTime = c, y.muted = _._muted || t._muted || d._muted || y.muted, y.volume = _._volume * d.volume(), y.playbackRate = _._rate;
                                        try {
                                            var o = y.play();
                                            if (o && "undefined" != typeof Promise && (o instanceof Promise || "function" == typeof o.then) ? (t._playLock = !0, A(), o.then((function() {
                                                    t._playLock = !1, y._unlocked = !0, n ? t._loadQueue() : t._emit("play", _._id)
                                                })).catch((function() {
                                                    t._playLock = !1, t._emit("playerror", _._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction."), _._ended = !0, _._paused = !0
                                                }))) : n || (t._playLock = !1, A(), t._emit("play", _._id)), y.playbackRate = _._rate, y.paused) return void t._emit("playerror", _._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                                            "__default" !== e || _._loop ? t._endTimers[_._id] = setTimeout(t._ended.bind(t, _), m) : (t._endTimers[_._id] = function() {
                                                t._ended(_), y.removeEventListener("ended", t._endTimers[_._id], !1)
                                            }, y.addEventListener("ended", t._endTimers[_._id], !1))
                                        } catch (e) {
                                            t._emit("playerror", _._id, e)
                                        }
                                    };
                                    "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" === y.src && (y.src = t._src, y.load());
                                    var x = window && window.ejecta || !y.readyState && d._navigator.isCocoonJS;
                                    if (y.readyState >= 3 || x) T();
                                    else {
                                        t._playLock = !0, t._state = "loading";
                                        var S = function() {
                                            t._state = "loaded", T(), y.removeEventListener(d._canPlayEvent, S, !1)
                                        };
                                        y.addEventListener(d._canPlayEvent, S, !1), t._clearTimer(_._id)
                                    }
                                }
                                return _._id
                            }
                        ...
                        pause: function(e) {
                            ...
                            for (var t = n._getSoundIds(e), i = 0; i < t.length; i++) {
                                ...
                                if (o && !o._paused && (o._seek = n.seek(t[i]), o._rateSeek = 0, o._paused = !0, n._stopFade(t[i]), o._node))
                                    if (n._webAudio) {
                        ...
                        mute: function(e, n) {
                            ...
                            for (var o = t._getSoundIds(n), i = 0; i < o.length; i++) {
                                var r = t._soundById(o[i]);
                                r && (r._muted = e, r._interval && t._stopFade(r._id), t._webAudio && r._node ? r._node.gain.setValueAtTime(e ? 0 : r._volume, d.ctx.currentTime) : r._node && (r._node.muted = !!d._muted || e), t._emit("mute", r._id))
                            }
                            return t
                        },
                        volume: function() {
                            ...
                            for (var i = 0; i < n.length; i++)(t = o._soundById(n[i])) && (t._volume = e, r[2] || o._stopFade(n[i]), o._webAudio && t._node && !t._muted ? t._node.gain.setValueAtTime(e, d.ctx.currentTime) : t._node && !t._muted && (t._node.volume = e * d.volume()), o._emit("volume", t._id));
                            return o
                        },
                        fade: function(e, n, t, o) {
                            ...
                            for (var _ = r._getSoundIds(o), i = 0; i < _.length; i++) {
                                ...
                                if (l) {
                                    if (o || r._stopFade(_[i]), r._webAudio && !l._muted) {
                                        var c = d.ctx.currentTime,
                                            f = c + t / 1e3;
                                        l._volume = e, l._node.gain.setValueAtTime(e, c), l._node.gain.linearRampToValueAtTime(n, f)
                                    }
                        ...
                        _startFadeInterval: function(e, n, t, o, r, d) {
                            ...
                            e._fadeTo = t, e._interval = setInterval((function() {
                                var r = (Date.now() - v) / o;
                                v = Date.now(), l += c * r, l = Math.round(100 * l) / 100, l = c < 0 ? Math.max(t, l) : Math.min(t, l), _._webAudio ? e._volume = l : _.volume(l, e._id, !0), d && (_._volume = l), (t < n && l <= t || t > n && l >= t) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, _.volume(t, e._id), _._emit("fade", e._id))
                            }), m)
                        },
                        _stopFade: function(e) {
                            var n = this,
                                t = n._soundById(e);
                            return t && t._interval && (n._webAudio && t._node.gain.cancelScheduledValues(d.ctx.currentTime), clearInterval(t._interval), t._interval = null, n.volume(t._fadeTo, e), t._fadeTo = null, n._emit("fade", e)), n
                        },
                        loop: function() {
                            var e, n, t, o = this,
                                r = arguments;
                            ...
                            for (var d = o._getSoundIds(n), i = 0; i < d.length; i++)(t = o._soundById(d[i])) && (t._loop = e, o._webAudio && t._node && t._node.bufferSource && (t._node.bufferSource.loop = e, e && (t._node.bufferSource.loopStart = t._start || 0, t._node.bufferSource.loopEnd = t._stop, o.playing(d[i]) && (o.pause(d[i], !0), o.play(d[i], !0)))));
                            return o
                        },
                        rate: function() {
                            var e, n, t, o = this,
                            ...
                            for (var i = 0; i < n.length; i++)
                                if (t = o._soundById(n[i])) {
                                    o.playing(n[i]) && (t._rateSeek = o.seek(n[i]), t._playStart = o._webAudio ? d.ctx.currentTime : t._playStart), t._rate = e, o._webAudio && t._node && t._node.bufferSource ? t._node.bufferSource.playbackRate.setValueAtTime(e, d.ctx.currentTime) : t._node && (t._node.playbackRate = e);
                                    var _ = o.seek(n[i]),
                                        l = 1e3 * ((o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) / 1e3 - _) / Math.abs(t._rate);
                                    !o._endTimers[n[i]] && t._paused || (o._clearTimer(n[i]), o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), l)), o._emit("rate", t._id)
                                }
                            return o
                        },
                        seek: function() {
                            ...
                            if (r) {
                                if (!("number" == typeof e && e >= 0)) {
                                    if (t._webAudio) {
                                        var _ = t.playing(n) ? d.ctx.currentTime - r._playStart : 0,
                                            l = r._rateSeek ? r._rateSeek - r._seek : 0;
                                        return r._seek + (l + _ * Math.abs(r._rate))
                                    }
                                    return r._node.currentTime
                                }
                                var c = t.playing(n);
                                c && t.pause(n, !0), r._seek = e, r._ended = !1, t._clearTimer(n), t._webAudio || !r._node || isNaN(r._node.duration) || (r._node.currentTime = e);
                                var f = function() {
                                    c && t.play(n, !0), t._emit("seek", n)
                                };
                                if (c && !t._webAudio) {
                                    var m = function() {
                                        t._playLock ? setTimeout(m, 0) : f()
                                    };
                                    setTimeout(m, 0)
                                } else f()
                            }
                        ...
                        playing: function(e) {
                            ...
                            for (var i = 0; i < n._sounds.length; i++)
                                if (!n._sounds[i]._paused) return !0;
                            return !1
                        },
                        duration: function(e) {
                            var n = this,
                        ...
                        unload: function() {
                            for (var e = this, n = e._sounds, i = 0; i < n.length; i++) n[i]._paused || e.stop(n[i]._id), e._webAudio || (e._clearSound(n[i]._node), n[i]._node.removeEventListener("error", n[i]._errorFn, !1), n[i]._node.removeEventListener(d._canPlayEvent, n[i]._loadFn, !1), n[i]._node.removeEventListener("ended", n[i]._endFn, !1), d._releaseHtml5Audio(n[i]._node)), delete n[i]._node, e._clearTimer(n[i]._id);
                            ...
                            return c && o && delete c[e._src], d.noAudio = !1, e._state = "unloaded", e._sounds = [], e = null, null
                        },
                        on: function(e, n, t, o) {
                            var r = this["_on" + e];
                        ...
                        off: function(e, n, t) {
                            ...
                            if ("number" == typeof n && (t = n, n = null), n || t)
                                for (i = 0; i < r.length; i++) {
                                    ...
                                    var _ = Object.keys(o);
                                    for (i = 0; i < _.length; i++) 0 === _[i].indexOf("_on") && Array.isArray(o[_[i]]) && (o[_[i]] = [])
                                }
                            return o
                        },
                        once: function(e, n, t) {
                        ...
                        _emit: function(e, n, t) {
                            for (var o = this, r = o["_on" + e], i = r.length - 1; i >= 0; i--) r[i].id && r[i].id !== n && "load" !== e || (setTimeout(function(e) {
                                e.call(this, n, t)
                        ...
                        _ended: function(e) {
                            ...
                            return n._webAudio && !o && (e._paused = !0, e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, n._clearTimer(e._id), n._cleanBuffer(e._node), d._autoSuspend()), n._webAudio || o || n.stop(e._id, !0), n
                        },
                        ...
                        _soundById: function(e) {
                            for (var n = this, i = 0; i < n._sounds.length; i++)
                                if (e === n._sounds[i]._id) return n._sounds[i];
                            return null
                        },
                        _inactiveSound: function() {
                            ...
                            for (var i = 0; i < e._sounds.length; i++)
                                if (e._sounds[i]._ended) return e._sounds[i].reset();
                            return new l(e)
                        },
                        _drain: function() {
                            var e = this,
                            ...
                            if (!(e._sounds.length < n)) {
                                for (i = 0; i < e._sounds.length; i++) e._sounds[i]._ended && t++;
                                for (i = e._sounds.length - 1; i >= 0; i--) {
                                    if (t <= n) return;
                                    e._sounds[i]._ended && (e._webAudio && e._sounds[i]._node && e._sounds[i]._node.disconnect(0), e._sounds.splice(i, 1), t--)
                                }
                            }
                        },
                        _getSoundIds: function(e) {
                            if (void 0 === e) {
                                for (var n = [], i = 0; i < this._sounds.length; i++) n.push(this._sounds[i]._id);
                                return n
                            }
                            return [e]
                        },
                        _refreshBuffer: function(e) {
                            return e._node.bufferSource = d.ctx.createBufferSource(), e._node.bufferSource.buffer = c[this._src], e._panner ? e._node.bufferSource.connect(e._panner) : e._node.bufferSource.connect(e._node), e._node.bufferSource.loop = e._loop, e._loop && (e._node.bufferSource.loopStart = e._start || 0, e._node.bufferSource.loopEnd = e._stop || 0), e._node.bufferSource.playbackRate.setValueAtTime(e._rate, d.ctx.currentTime), this
                        },
                        _cleanBuffer: function(e) {
                            var n = d._navigator && d._navigator.vendor.indexOf("Apple") >= 0;
                            if (!e.bufferSource) return this;
                            if (d._scratchBuffer && e.bufferSource && (e.bufferSource.onended = null, e.bufferSource.disconnect(0), n)) try {
                    ...
                    l.prototype = {
                        ...
                        _loadListener: function() {
                            ...
                            }), "loaded" !== n._state && (n._state = "loaded", n._emit("load"), n._loadQueue()), e._node.removeEventListener(d._canPlayEvent, e._loadFn, !1)
                        },
                    ...
                    var c = {},
                        f = function(e) {
                            var n = e._src;
                            if (c[n]) return e._duration = c[n].duration, void h(e);
                            if (/^data:[^;]+;base64,/.test(n)) {
                                for (var data = atob(n.split(",")[1]), t = new Uint8Array(data.length), i = 0; i < data.length; ++i) t[i] = data.charCodeAt(i);
                                v(t.buffer, e)
                            } else {
                                var o = new XMLHttpRequest;
                                o.open(e._xhr.method, n, !0), o.withCredentials = e._xhr.withCredentials, o.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach((function(n) {
                                    ...
                                    e._webAudio && (e._html5 = !0, e._webAudio = !1, e._sounds = [], delete c[n], e.load())
                                }, m(o)
                            }
                        },
                        m = function(e) {
                        ...
                        v = function(e, n) {
                            var t = function() {
                                ...
                                o = function(e) {
                                    e && n._sounds.length > 0 ? (c[n._src] = e, h(n, e)) : t()
                                };
                        ...
                        A = function() {
                            if (d.usingWebAudio) {
                                ...
                                d.usingWebAudio && (d.masterGain = void 0 === d.ctx.createGain ? d.ctx.createGainNode() : d.ctx.createGain(), d.masterGain.gain.setValueAtTime(d._muted ? 0 : d._volume, d.ctx.currentTime), d.masterGain.connect(d.ctx.destination)), d._setup()
                            }
                        };
                    void 0 === (o = function() {
                        return {
                    ...
                    }.apply(n, [])) || (e.exports = o), n.Howler = d, n.Howl = _, void 0 !== t ? (t.HowlerGlobal = r, t.Howler = d, t.Howl = _, t.Sound = l) : "undefined" != typeof window && (window.HowlerGlobal = r, window.Howler = d, window.Howl = _, window.Sound = l)
                }(),
                function() {
                    "use strict";
                    var e;
                    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(e) {
                        ...
                        for (var i = n._howls.length - 1; i >= 0; i--) n._howls[i].stereo(e);
                        return n
                        ...
                        for (var d = o._getSoundIds(t), i = 0; i < d.length; i++) {
                            ...
                            if (_) {
                                if ("number" != typeof e) return _._stereo;
                                _._stereo = e, _._pos = [e, 0, 0], _._node && (_._pannerAttr.panningModel = "equalpower", _._panner && _._panner.pan || n(_, r), "spatial" === r ? void 0 !== _._panner.positionX ? (_._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime), _._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), _._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : _._panner.setPosition(e, 0, 0) : _._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)), o._emit("stereo", _._id)
                            }
                        }
                        return o
                        ...
                        if (t = "number" != typeof t ? d._orientation[1] : t, o = "number" != typeof o ? d._orientation[2] : o, void 0 === r) {
                        ...
                        if (0 === d.length) return r._pannerAttr;
                        if (1 === d.length) {
                            if ("object" != typeof d[0]) return (o = r._soundById(parseInt(d[0], 10))) ? o._pannerAttr : r._pannerAttr;
                            e = d[0], void 0 === t && (e.pannerAttr || (e.pannerAttr = {
                        ...
                        } else 2 === d.length && (e = d[0], t = parseInt(d[1], 10));
